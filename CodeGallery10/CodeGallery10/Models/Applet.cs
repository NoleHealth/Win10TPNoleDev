...
namespace MOS.CodeGallery10.Models
{
    ...
    public class Group
    {
        ...
        public static Group GetNewContact()
        {
            return new Group()
            {
        ...
        public static ObservableCollection<Group> GetGroups(int numberOfGroups)
        {
            var contacts = new ObservableCollection<Group>();
        ...
        public static ObservableCollection<GroupInfoList> GetContactsGrouped(int numberOfGroups)
        {
            ObservableCollection<GroupInfoList> groups = new ObservableCollection<GroupInfoList>();

            var query = from item in GetGroups(numberOfGroups)
